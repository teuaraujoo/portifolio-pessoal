                ...
                <div className="icons-container">
                  ...
                  <div className="icons">
                    {project.icons && project.icons.map((icon, idx) => {
                      if (icon === 'custom-svg') {
                        return (
                          <svg key={idx} xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      return <i key={idx} className={icon}></i>;
                    })}
                  </div>
                </div>
